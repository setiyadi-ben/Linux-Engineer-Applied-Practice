...
([**Commands are putting up here**]([./terminal-command.md#210](https://github.com/setiyadi-ben/Linux-Engineer-Applied-Practice/main/Database-Replication-Simulation/terminal-command.md#210)))
<center>
